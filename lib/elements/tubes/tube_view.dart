...
class TubeView extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) async {
    final rectBottom = Rect.fromLTRB(
        position + 0.0,
        ScreenUtils.screenHeight - random,
        position - 40.0,
        ScreenUtils.screenHeight);
    final rectTop = new Rect.fromLTRB(position - 40.0, 0.0, position + 0.0,
        ScreenUtils.screenHeight / 2 - random);
